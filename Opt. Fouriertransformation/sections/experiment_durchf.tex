...
\begin{figure}[h]
	\centering
	\includegraphicsRS[width=0.7\textwidth][0.7]{images/image_X5K66X.png}
...
%Dabei ist die Intensitätsverteilung im Bild proportional zum Quadrat der Phasenverschiebung durch die Schlieren. Somit ermöglicht es dieses Verfahren, eine Phasenverschiebung sichtbar zu machen.
...
\begin{figure}[h]
	\centering
	\includegraphicsRS[width=0.7\textwidth][0.7]{images/image_D02K8X.png}
