...
\begin{document}
	...
	\begin{pspicture}[showgrid](0,0)(15,2) %[showgrid]
	...
	\optretplate[beam, compname=LH](L0)(L1){$\nicefrac{\lambda}{2}$}
	...
	\optplate[plateheight=1.5, labelangle=180, labeloffset=1, compname=CCD1, position=.5](L5)(L6){CCD}
