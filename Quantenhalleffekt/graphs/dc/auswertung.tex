...
\begin{document}
	...
	\begin{axis}[
		...
		\addplot[mark=x, only marks] table[select coords between index={2}{17}, x index=1, y index=3] {../data/gleichspannung/ausgewertet.dat};
		\addlegendentry{SDHO mit Minima $\rho_{xx}\neq 0$}
		
		\addplot[mark=o, only marks, forget plot] table[select coords between index={0}{1}, x index=1, y index=3] {../data/gleichspannung/ausgewertet.dat};
		\addplot[mark=o, only marks] table[select coords between index={18}{20}, x index=1, y index=3] {../data/gleichspannung/ausgewertet.dat};
		\addlegendentry{SDHO mit Minima $\rho_{xx}=0$}
		%\addlegendentry{$U_H$}
		
		\addplot[red, mark=\empty] {x*13.14623240680909}; %1.314623240680909e+01 +/- 1.895065278600170e-02
