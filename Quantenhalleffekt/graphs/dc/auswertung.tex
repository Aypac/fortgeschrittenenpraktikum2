...
\begin{document}
	...
	\begin{axis}[
		...
		\addplot[mark=x, only marks] table[select coords between index={3}{16}, x index=1, y index=3] {../data/gleichspannung/ausgewertet.dat};
		\addlegendentry{SDHO mit Minima $\rho_{xx}\neq 0$}
		
		\addplot[mark=o, only marks, forget plot] table[select coords between index={0}{2}, x index=1, y index=3] {../data/gleichspannung/ausgewertet.dat};
		\addplot[mark=o, only marks] table[select coords between index={17}{20}, x index=1, y index=3] {../data/gleichspannung/ausgewertet.dat};
