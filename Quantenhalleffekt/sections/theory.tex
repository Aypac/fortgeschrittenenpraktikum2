...
\begin{figure}[h]
	\centering
	\includegraphicsRS[width=0.4\linewidth][0.5]{images/Anleitungsheft/U_HALL_Anleitungsheft.png}
...
\begin{figure}
\centering
\includegraphicsRS[width=0.4\linewidth][0.5]{images/Anleitungsheft/Hallstreifen_Geometrie_Anleitungsheft.png}
...
\begin{figure}[h]
	\centering
	\includegraphicsRS[width=0.5\linewidth][0.6]{images/Anleitungsheft/QH_Bsp_Messung_Anleitungsheft.png}
