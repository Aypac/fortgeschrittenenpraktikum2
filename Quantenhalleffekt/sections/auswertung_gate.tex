...
Die Ladungsträgerdichten wurden dabei analog zu den obigen Versuchsteilen aus der Näherung über die Hall-Spannung bestimmt und es ergaben sich die Werte in Tabelle~\ref{tab:gate_ausw}. %Der Abstand d des 2DEG zur Probenoberfläche wurde mittels linearer Regression bestimmt. Dafür ergab sich ein Wert von $d=...$ %TODO: WERT ANGEBEN
